...
.. admonition:: SLH-DSA Signature Creation
   ...
   **Input:**
   ...
   -  ``SK``: SLH-DSA secret key, ``SK = {sk_seed, sk_prf, pub_seed, root}``
   ...
   **Steps:**
   ...
   3. ``sig = slh_sign_internal(internal_msg, SK, addrnd)``
...
Algorithm 24 of [FIPS-205]_ (see :srcref:`[src/lib/pubkey/sphincsplus/sphincsplus_common]/sphincsplus.cpp:158|is_valid_signature`):
