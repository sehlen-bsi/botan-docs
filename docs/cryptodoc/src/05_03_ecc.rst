...
:srcref:`[src/lib/pubkey/ec_group]/ec_group.cpp:533|EC_Group`). Previous
...
in :srcref:`src/lib/pubkey/ecc_key/ecc_key.cpp:142|EC_PrivateKey`. To generate a
...
:srcref:`[src/lib/pubkey/ecdsa]/ecdsa.cpp:232|verify`):
...
The signature generation algorithm works as follows (see
:srcref:`[src/lib/pubkey/eckcdsa]/eckcdsa.cpp:164|raw_sign`):
...
The signature verification algorithm works as follows (see
:srcref:`[src/lib/pubkey/eckcdsa]/eckcdsa.cpp:236|verify`):
