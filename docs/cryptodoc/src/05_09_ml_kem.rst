...
ML-KEM in a hybrid form in a suitable combination with a traditional key agreement
...
.. table::  ML-KEM Algorithms Overview
   ...
   +==============================+=============================================================================================+======================================================================+===========================+
   | ``encode_polynomial_vector`` | :srcref:`[src/lib/pubkey/kyber/kyber_common]/kyber_algos.cpp:186|encode_polynomial_vector`  | Byte encoding of polynomial vectors                                  | 5                         |
   +------------------------------+---------------------------------------------------------------------------------------------+----------------------------------------------------------------------+---------------------------+
   | ``decode_polynomial_vector`` | :srcref:`[src/lib/pubkey/kyber/kyber_common]/kyber_algos.cpp:194|decode_polynomial_vector`  | Byte decoding of polynomial vectors                                  | 6                         |
   +------------------------------+---------------------------------------------------------------------------------------------+----------------------------------------------------------------------+---------------------------+
   | ``polynomial_from_message``  | :srcref:`[src/lib/pubkey/kyber/kyber_common]/kyber_algos.cpp:206|polynomial_from_message`   | Byte decoding of the K-PKE message :math:`m`                         | 6                         |
   +------------------------------+---------------------------------------------------------------------------------------------+----------------------------------------------------------------------+---------------------------+
   | ``polynomial_to_message``    | :srcref:`[src/lib/pubkey/kyber/kyber_common]/kyber_algos.cpp:214|polynomial_to_message`     | Byte encoding of the K-PKE message :math:`m`                         | 5                         |
   +------------------------------+---------------------------------------------------------------------------------------------+----------------------------------------------------------------------+---------------------------+
...
.. table::  Polynomial Sampling Methods
   ...
   +==========================================+===================================================================================================+=====================================================================+
   | ``sample_polynomial_vector_cbd_eta1``    | :srcref:`[src/lib/pubkey/kyber/kyber_common]/kyber_algos.h:67|sample_polynomial_vector_cbd_eta1`  | Polynomial vector sampling in :math:`\mathcal{D}_{\eta_1}(R_q)`     |
   +------------------------------------------+---------------------------------------------------------------------------------------------------+---------------------------------------------------------------------+
   | ``sample_polynomial_cbd_eta2``           | :srcref:`[src/lib/pubkey/kyber/kyber_common]/kyber_algos.h:75|sample_polynomial_cbd_eta2`         | Polynomial sampling in :math:`\mathcal{D}_{\eta_2}(R_q)`            |
   +------------------------------------------+---------------------------------------------------------------------------------------------------+---------------------------------------------------------------------+
   | ``sample_polynomial_vector_cbd_eta2``    | :srcref:`[src/lib/pubkey/kyber/kyber_common]/kyber_algos.h:83|sample_polynomial_vector_cbd_eta2`  | Polynomial vector sampling in :math:`\mathcal{D}_{\eta_2}(R_q)`     |
   +------------------------------------------+---------------------------------------------------------------------------------------------------+---------------------------------------------------------------------+
...
(:srcref:`[src/lib/pubkey/kyber/kyber_common]/kyber_symmetric_primitives.h:28|Kyber_Symmetric_Primitives`).
...
:srcref:`[src/lib/pubkey/kyber]/kyber_common/kyber_algos.cpp:323|expand_keypair`.
...
:srcref:`[src/lib/pubkey/kyber]/ml_kem/ml_kem_impl.cpp:24|ML_KEM_Encryptor::encapsulate`.
They use the K-PKE encapsulation algorithm (Algorithm 14 of [FIPS-203]_)
implemented in
:srcref:`[src/lib/pubkey/kyber]/kyber_common/kyber_keys.cpp:130|Kyber_PublicKeyInternal::indcpa_encrypt`.
In combination, Botan does the following:
...
.. admonition:: ML_KEM_Encryptor::encapsulate
   ...
   **Notes:**
   ...
   - Steps 1-3 correspond to Algorithms 20 and 17 of [FIPS-203]_ and are
     performed in :srcref:`[src/lib/pubkey/kyber]/ml_kem/ml_kem_impl.cpp:24|ML_KEM_Encryptor::encapsulate`.
   - Steps 3.1-3.9 correspond to Algorithms 14 of [FIPS-203]_ and are performed
     in :srcref:`[src/lib/pubkey/kyber]/kyber_common/kyber_keys.cpp:130|indcpa_encrypt`.
...
:srcref:`[src/lib/pubkey/kyber]/ml_kem/ml_kem_impl.cpp:47|ML_KEM_Decryptor::decapsulate`.
They use the K-PKE encapsulation and decapsulation algorithms (Algorithm 14
and 15 of [FIPS-203]_) implemented in
:srcref:`[src/lib/pubkey/kyber]/kyber_common/kyber_keys.cpp:130|Kyber_PublicKeyInternal::indcpa_encrypt`
and
:srcref:`[src/lib/pubkey/kyber]/kyber_common/kyber_keys.cpp:160|Kyber_PrivateKeyInternal::indcpa_decrypt`.
In combination, Botan does the following:
...
.. admonition:: ML_KEM_Decryptor::decapsulate
   ...
   **Notes:**
   ...
   - Steps 1-6 correspond to Algorithm 18 of [FIPS-203]_ and are
     performed in :srcref:`[src/lib/pubkey/kyber]/ml_kem/ml_kem_impl.cpp:47|ML_KEM_Decryptor::decapsulate`.
   - Steps 2.1-2.3 correspond to Algorithm 15 of [FIPS-203]_ and are performed
     in :srcref:`[src/lib/pubkey/kyber]/kyber_common/kyber_keys.cpp:160|Kyber_PrivateKeyInternal::indcpa_decrypt`.
