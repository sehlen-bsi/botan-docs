...
.. table::
   ...
   |                        |                                                                         |
   |                        | #. Check that the ciphertext length bound for the *Msg* length          |
   |                        |    reported by the encryptor equals the bound reported by the           |
   |                        |    decryptor                                                            |
   |                        |                                                                         |
   ...
   |                        |                                                                         |
   |                        | #. Check that the length of the *Ciphertext* does not exceed the        |
   |                        |    ciphertext length bound reported by the decryptor                    |
   +------------------------+-------------------------------------------------------------------------+
...
.. table::
   ...
   |                        |                                                                         |
   |                        | #. Check that the ciphertext length bound for the *Plaintext* length    |
   |                        |    reported by the ECIES_Encryptor equals the bound reported by the     |
   |                        |    ECIES_Decryptor                                                      |
   |                        |                                                                         |
   |                        | #. Encrypt the *Plaintext* using the ECIES_Encryptor                    |
   |                        |                                                                         |
   |                        | #. Check that the length of the generated ciphertext does not exceed    |
   |                        |    the ciphertext length bound reported by the ECIES_Decryptor          |
   |                        |                                                                         |
   |                        | #. Decrypt the ciphertext generated by the previous step using the      |
   |                        |    ECIES_Decryptor and compare the output with the *Plaintext*          |
   |                        |                                                                         |
   |                        | #. Check that the *Plaintext* length does not exceed the plaintext      |
   |                        |    length bound reported by the ECIES_Decryptor for the ciphertext      |
   |                        |    length                                                               |
   |                        |                                                                         |
