...
invalid test vector. The test vectors for the first two test cases are
included as certificates in :srcref:`src/tests/data/x509/name_constraint`;
the certificates for the remaining test cases are located in
:srcref:`src/tests/data/x509/name_constraint_san`,
:srcref:`src/tests/data/x509/misc/name_constraint_ci`, and
:srcref:`src/tests/data/x509/misc/nc_skip_self`.
