...
Dieses Leak gibt jedoch nur Informationen über den berechneten Hash preis.
Der Hashwert wird erzeugt mithilfe von öffentlichen Daten.
Diese sind das zufällig gewählte Salt, der öffentliche Schlüssel und die zu signierende Nachricht. 
